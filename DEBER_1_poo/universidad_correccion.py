...
class Nota:
    def __init__(self):
        ...
        self.notafinal = 0
        self.Estado = ""
        self.imprimir = ActaCalificacion(1)
    ...
    def mostarNotas(self):
        self.imprimir.detalleActa(self.N1,self.N2,self.N3,self.N4,self.Exm1,self.Exm2,self.nota_final,self.estudent,self.Estado)
